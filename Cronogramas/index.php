...
<li class="navbar-item">
   ...
   <div class="mini-banner">
    ...
    <!-- Título "Etapas" -->
    <div class="etapas">
        <h2>Cronogramas Personalisados </h2>
    </div>

    <div class="container cronogramas">
    <section class="grid">
            <!-- Primeira fileira de eventos -->
            <div class="card free">
                <h2>Cronograma</h2>
                <p class="date">Data: 12/11 - 14/11</p>
                <img src="crono.jpg" alt="Imagem do evento" class="event-image">
                <button onclick="window.location.href='download.php?file=crono1.xlsx'">Baixar Cronograma</button>
                <span class="status">Gratuito</span>
            </div>

            <div class="card paid">
                <h2>Cronograma</h2>
                <p class="date">Data: 15/11 - 16/11</p>
                <img src="crono.jpg" alt="Imagem do evento" class="event-image">
                <!-- Redirecionamento para a página de pagamento -->
                <button onclick="window.location.href='../Pagamento/index.php?event=cronograma2'">Comprar</button>
            ...
            <div class="card paid">
                <h2>Cronograma</h2>
                <p class="date">Data: 23/11 - 24/11</p>
                <img src="crono.jpg" alt="Imagem do evento" class="event-image">
                <!-- Redirecionamento para a página de pagamento -->
                <button onclick="window.location.href='pagamento.php?event=cronograma3'">Comprar</button>
                <span class="status">Pago</span>
            </div>

            <!-- Segunda fileira de eventos -->
            <div class="card free">
                <h2>Cronograma</h2>
                <p class="date">Data: 12/11 - 14/11</p>
                <img src="crono.jpg" alt="Imagem do evento" class="event-image">
            ...
            <div class="card paid">
                <h2>Cronograma</h2>
                <p class="date">Data: 28/11 - 29/11</p>
                <img src="crono.jpg" alt="Imagem do evento" class="event-image">
                <!-- Redirecionamento para a página de pagamento -->
                <button onclick="window.location.href='pagamento.php?event=cronograma4'">Comprar</button>
                <span class="status">Pago</span>
            </div>
            ...
            <div class="card paid">
                <h2>Cronograma</h2>
                <p class="date">Data: 03/12 - 04/12</p>
                <img src="crono.jpg" alt="Imagem do evento" class="event-image">
                <!-- Redirecionamento para a página de pagamento -->
                <button onclick="window.location.href='pagamento.php?event=cronograma5'">Comprar</button>
                <span class="status">Pago</span>
            </div>

            <!-- Terceira fileira de eventos -->
            <div class="card free">
                <h2>Cronograma</h2>
                <p class="date">Data: 12/11 - 14/11</p>
                <img src="crono.jpg" alt="Imagem do evento" class="event-image">
            ...
            <div class="card paid">
                <h2>Cronograma</h2>
                <p class="date">Data: 07/12 - 08/12</p>
                <img src="crono.jpg" alt="Imagem do evento" class="event-image">
                <!-- Redirecionamento para a página de pagamento -->
                <button onclick="window.location.href='pagamento.php?event=cronograma6'">Comprar</button>
                <span class="status">Pago</span>
            </div>
            ...
            <div class="card paid">
                <h2>Cronograma</h2>
                <p class="date">Data: 11/12 - 12/12</p>
                <img src="crono.jpg" alt="Imagem do evento" class="event-image">
                <!-- Redirecionamento para a página de pagamento -->
                <button onclick="window.location.href='pagamento.php?event=cronograma7'">Comprar</button>
                <span class="status">Pago</span>
            </div>
        </section>
    </div>
